...
public class User implements Serializable {
    ...
    // Using FetchType.Lazy to resolve multiple bags exception
    ...
    // Generating constructors for both with and without arguments
    // This is done for all model entities because Java will NOT autogenerate no-argument constructors if
    // we create any constructor
    public User() {
    }
